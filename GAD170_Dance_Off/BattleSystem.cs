...
public class BattleSystem : MonoBehaviour
{
    ...
    {
        int randStyle = Random.Range(5, 15) * 2;
        int randLuck = Random.Range(5, 15) * 2;
        int randRythmn = Random.Range(5, 15) * 2;


        int playerPower = ReturnDancePowerLevel(randStyle, randLuck, randRythmn);
        int npcPower = ReturnDancePowerLevel(randStyle, randLuck, randRythmn);
