...
public class StatsSystem : MonoBehaviour
{
   ...
   // {
   //    int RandomNum = Random.int(1, maxint);
   // }
    ...
    public void GeneratePhysicalStatsStats()
    {
        ...
        agility += Random.Range(2, MainTotalPoints/2);
        MainTotalPoints -= agility;
        intelligence += Random.Range(2, MainTotalPoints/2);
        MainTotalPoints -= intelligence;
        strength += MainTotalPoints;
    }
    ...
    public void CalculateDancingStats()
    {
        ...
        style = Mathf.RoundToInt((float)agility * agilityMultiplier);
        luck = Mathf.RoundToInt((float)intelligence * inteligenceMultiplier);
        rhythm = Mathf.RoundToInt((float)strength * strengthMultiplier);
    ...
    public void DistributePhysicalStatsOnLevelUp(int PointsPool)
    {
        ...
        /// add 10 to total points after level up and re run 
        MainTotalPoints += 10;
